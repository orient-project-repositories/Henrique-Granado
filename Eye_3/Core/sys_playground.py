...
class MotorApp(tk.Frame):
    def __init__(self, master, objects):
        ...
        self.widgets = [self.motor1_label, self.motor1_slider, self.motor2_label, self.motor2_slider, self.motor3_label, self.motor3_slider, self.update_button, self.auto_update]
    ...
    def update_widgets(self):
        ...
        self.auto_update.grid(row=3, column=0)
    ...
    def update_model(self):
        self.model.feed_input([radians(self.motor1_slider.get()), radians(self.motor2_slider.get()), radians(self.motor3_slider.get())])
...
class Window(pyglet.window.Window):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.model_list = []
        self.player = Player((-2.5, 0, -1.5),(0, -120))
    ...
    def lighting_setup(self):
        ...
        glLightfv(GL_LIGHT0, GL_POSITION, (GLfloat * 4)(0, 10, 0, 1))
        # glLightfv(GL_LIGHT0, GL_LINEAR_ATTENUATION, (GLfloat)(0.03))
        # glLightfv(GL_LIGHT0, GL_SPOT_DIRECTION, (GLfloat*3)(0, -1, 0))
        glEnable(GL_LIGHT0)
