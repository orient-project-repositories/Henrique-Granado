...
class CustomEnv(Env):  # basic setup of an environment from OpenAI Gym library to use the RL algorithms on it
    ...
    def step(self, action): # the action that is applied at each time step. Here the action represents the orientation of the motor at that time step
